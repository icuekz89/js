      ...
      try {
        ...
        if (_0x2dc6f8[1] === undefined) {
          if (_0x3faabc == _0x2ac1e3) {
            console.log('Developed by. eltoko.id')
            return
          } else {
